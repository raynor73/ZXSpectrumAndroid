...
Java_ru_ilapin_zxspectrum_ZxSpectrumActivity2_getExceededInstructionsPercent(JNIEnv *env, jobject instance) {
    if (g_zxSpectrum == nullptr) {
        return 0;
    }
...
JNIEXPORT jint JNICALL
Java_ru_ilapin_zxspectrum_ZxSpectrumActivity2_getInstructionsCount(JNIEnv *env, jobject instance) {
    if (g_zxSpectrum == nullptr) {
        return 0;
    }
